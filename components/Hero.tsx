          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <h1 className="font-black leading-[0.9]">
                <span className="block whitespace-nowrap text-[2rem] sm:text-[3.75rem] md:text-[5.5rem] lg:text-[7.5rem] xl:text-[9rem] text-white tracking-[-0.02em] sm:tracking-[0.01em]">
                  CRAFT CODE
                </span>
              </h1>
            </motion.div>
