...
//   return (
//     <>
//       <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 sm:px-12 lg:px-24 bg-black">

//         {/* ========== BALANCED GLOW - PC LIGHT, MOBILE BRIGHT ========== */}
//         <div className="absolute inset-0 overflow-hidden pointer-events-none">
          
//           {/* GLOW SPOT 1: TOP LEFT */}
//           <motion.div
//             className={`absolute top-[5%] left-[5%] w-[45%] h-[45%] rounded-full ${
//               isMobile 
//                 ? 'bg-[#2563EB]/30 blur-[150px]' 
//                 : 'bg-[#2563EB]/15 blur-[140px]'
//             }`}
//             animate={{
//               scale: [1, 1.06, 1],
//               opacity: isMobile 
...
//           {/* GLOW SPOT 2: BOTTOM RIGHT */}
//           <motion.div
//             className={`absolute bottom-[10%] right-[5%] w-[40%] h-[40%] rounded-full ${
//               isMobile 
//                 ? 'bg-[#2563EB]/25 blur-[140px]' 
//                 : 'bg-[#2563EB]/12 blur-[130px]'
//             }`}
//             animate={{
//               scale: [1, 1.08, 1],
//               opacity: isMobile 
...
//           {/* GLOW SPOT 3: CENTER */}
//           <motion.div
//             className={`absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[55%] h-[55%] rounded-full ${
//               isMobile 
//                 ? 'bg-[#2563EB]/22 blur-[180px]' 
//                 : 'bg-[#2563EB]/10 blur-[160px]'
//             }`}
//             animate={{
//               scale: [1, 1.04, 1],
//               opacity: isMobile 
...
//               scale: [1, 1.03, 1],
//               rotate: [0, 2, -2, 0],
//               opacity: isMobile ? [1, 1.2, 1] : [0.8, 1, 0.8],
//             }}
//             transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
//           >
//             <div className={`absolute top-[30%] right-[10%] w-[25%] h-[25%] rounded-full ${
//               isMobile 
//                 ? 'bg-[#1D4ED8]/25 blur-[120px]' 
//                 : 'bg-[#1D4ED8]/12 blur-[100px]'
//             }`} />
//             <div className={`absolute bottom-[30%] left-[15%] w-[20%] h-[20%] rounded-full ${
//               isMobile 
//                 ? 'bg-[#3B82F6]/20 blur-[100px]' 
//                 : 'bg-[#3B82F6]/10 blur-[80px]'
//             }`} />
//           </motion.div>
...
//           >
//             <div className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-full bg-gradient-to-t to-transparent blur-[120px] ${
//               isMobile 
//                 ? 'from-[#2563EB]/30 via-[#2563EB]/15' 
//                 : 'from-[#2563EB]/15 via-[#2563EB]/6'
//             }`} />
//           </motion.div>
...
//             <h1 className="font-black tracking-[-0.06em] leading-[0.9]">
//               <span className="block text-[3.5rem] sm:text-[6.5rem] md:text-[8rem] lg:text-[9.5rem] xl:text-[11rem] text-white tracking-[0.02em]">
//                 CRAFT CODE
//               </span>
//             </h1>
//           </motion.div>
...
//               <button className="group relative w-full sm:w-auto overflow-hidden px-6 sm:px-8 py-3 sm:py-4 bg-[#2563EB] text-white rounded-full font-medium transition-all duration-300 hover:bg-[#1D4ED8] hover:scale-105 active:scale-95 shadow-lg shadow-blue-600/20 cursor-pointer text-sm sm:text-base">
...
//                   initial="idle"
//                   whileHover="hover"
//                   className="absolute inset-0 rounded-full bg-[#2563EB] blur-xl"
//                 />
//               )}
//               <Link href="/work" className="w-full sm:w-auto cursor-pointer">
//                 <button className="relative w-full sm:w-auto rounded-full border border-[#2563EB] px-6 sm:px-8 py-3 sm:py-4 text-[#2563EB] transition-all duration-500 hover:scale-105 overflow-hidden group cursor-pointer bg-transparent hover:bg-[#2563EB] hover:text-white font-medium text-sm sm:text-base">
//                   <motion.div
...
//       <div className="relative py-4 sm:py-6 bg-neutral-950 border-y border-neutral-900 overflow-hidden select-none flex whitespace-nowrap">
//         <motion.div 
...
//       {/* CRAFTCODE Studio Info Section */}
//       <section className="relative py-16 sm:py-24 lg:py-36 px-4 sm:px-6 lg:px-24 bg-black">
//         <div className="max-w-[1600px] mx-auto">
          
//           <motion.div 
//             className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 sm:mb-20 gap-6 sm:gap-8"
...
//               <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black text-white/90 text-center sm:text-left tracking-[-0.06em]">
//                 CRAFT<span className="text-[#2563EB]"> CODE</span>
//               </h2>
//             </div>
...
//               viewport={{ once: true }}
//               className="text-gray-400 text-base sm:text-lg md:text-xl lg:text-2xl max-w-xl font-light tracking-wide leading-relaxed text-center sm:text-left"
//             >
...
//                 whileHover="hover"
//                 className="group relative p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-neutral-950 border border-neutral-900 hover:border-blue-600/40 transition-all duration-500 flex flex-col h-auto min-h-[180px] sm:min-h-[200px] lg:min-h-[220px] overflow-hidden cursor-pointer"
//               >
...
function PremiumHeroBackground() {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      {/* Floating Orbs - Primary large orb (Blue) */}
      <motion.div
      ...
      {/* Central subtle glow */}
      <motion.div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-blue-600/4 rounded-full blur-[180px]"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      {/* Floating particles - tiny dots orbiting */}
      {[...Array(20)].map((_, i) => {
      ...
      {/* Additional floating micro-particles */}
      {[...Array(30)].map((_, i) => (
        <motion.div
          key={`micro-${i}`}
      ...
      {/* Very subtle connecting lines between orbs */}
